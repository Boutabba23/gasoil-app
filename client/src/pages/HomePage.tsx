...
console.log("VITE_API_GOOGLE_LOGIN_URL from import.meta.env:", import.meta.env.VITE_API_GOOGLE_LOGIN_URL);
...
const HomePage: React.FC = () => {
  ...
  const handleLogin = () => {
    ...
    console.log("HomePage: VITE_API_GOOGLE_LOGIN_URL =", googleLoginInitiationUrl); // Log the env var
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-between pt-36 min-h-screen 
                  bg-gradient-to-br from-[#fffbe7] to-[#FFF1A7] 
                   text-slate-800 p-4 sm:p-6 md:p-8 overflow-y-auto"> {/* Added overflow-y-auto */}
      
      {/* This div will group the main card and the footer, allowing them to flow naturally */}
      <div className="flex flex-col items-start w-full max-w-lg"> {/* max-w-lg to constrain width */}
        ...
        >
          ...
          <div className="mt-8 flex justify-center "> 
            <Button className='hover:cursor-pointer' onClick={() => {
              ...
              <img src={googleLogoUrl} alt="Google G logo" className="w-5 h-5 mr-3" />
      ...
      </div> {/* End of grouping div for card and footer */}
      <motion.footer
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}

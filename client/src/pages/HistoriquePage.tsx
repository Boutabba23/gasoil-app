...
const HistoriquePage: React.FC = () => {
  ...
  const handleApplyFilters = useCallback(() => {
    ...
    console.log("Applying filters. Search:", inputSearchTerm, "DateRange:", dateRange);
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Affinez votre recherche par terme (valeur en cm ou volume en L) ou sélectionnez une période.
          </CardDescription>
        </CardHeader>
          ...
          {(activeSearchTerm || (dateRange?.from && dateRange?.to)) && (
            <CardDescription className="text-xs">
              ...
              {(dateRange?.from && dateRange?.to) && 
                `Période du ${format(dateRange.from, "dd/MM/yy", {locale:fr})} au ${format(dateRange.to, "dd/MM/yy", {locale:fr})}`
              }
            </CardDescription>
          )}
        </CardHeader>
